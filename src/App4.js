//No color for wrong/correct answer & start automatically
...
const QuizApp = () => {
  ...
  const handleAnswerSelect = (answer) => {
    if (!userAnswers[currentQuestion] && !quizFinished) {
      ...
      // Commented out the setShowCorrectAnswers line to hide correct answer after user selects an answer
      // setShowCorrectAnswers(true);

      // Automatically move to the next question after the user clicks an answer
      setTimeout(() => {
